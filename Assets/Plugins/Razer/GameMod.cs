...
{
    public class GameMod : IDisposable
    {
        public class Editor : IDisposable
        {
            ...
            static Editor()
            {
                ...
                {
                    {
                        string strName = "com/razerzone/store/sdk/content/GameMod$Editor";
            ...
            {
                {
                    ...
                    _jmAddScreenshot = AndroidJNI.GetMethodID(_jcEditor, strMethod, "(Landroid/graphics/Bitmap;)Lcom/razerzone/store/sdk/content/GameModScreenshot;");
...

                {
                    ...
                    _jmRemoveScreenshot = AndroidJNI.GetMethodID(_jcEditor, strMethod, "(Lcom/razerzone/store/sdk/content/GameModScreenshot;)V");
            ...
            public void removeScreenshot(GameModScreenshot screenshot)
            {
#if VERBOSE_LOGGING
                Debug.Log(string.Format("Invoking {0}...", MethodBase.GetCurrentMethod().Name));
#endif
        ...
        private static IntPtr _jcGameMod = IntPtr.Zero;
        ...
        static GameMod()
        {
            try
            {
                IntPtr localRef;
                {
                    string strName = "com/razerzone/store/sdk/content/GameMod";
                    ...
                    if (localRef != IntPtr.Zero)
                    {
                        ...
                        Debug.Log(string.Format("Found {0} class", strName));
#endif
                        _jcGameMod = AndroidJNI.NewGlobalRef(localRef);
                        AndroidJNI.DeleteLocalRef(localRef);
                    }
                    else
                    {
        ...
        {
            {
                ...
                _jmGetCategory = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Ljava/lang/String;");
...

            {
                ...
                _jmGetDescription = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Ljava/lang/String;");
...

            {
                ...
                _jmGetFilenames = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Ljava/util/List;");
...

            {
                ...
                _jmGetMetaData = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Ljava/lang/String;");
...

            {
                ...
                _jmGetScreenshots = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Ljava/util/List;");
...

            {
                ...
                _jmGetTags = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Ljava/util/List;");
        ...
        
            {
                ...
                _jmGetTitle = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Ljava/lang/String;");
...

            {
                ...
                _jmEdit = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Lcom/razerzone/store/sdk/content/GameMod$Editor;");
...

            {
                ...
                _jmIsPublished = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Z");
...

            {
                ...
                _jmIsInstalled = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Z");
...

            {
                ...
                _jmIsDownloading = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Z");
...

            {
                ...
                _jmFlag = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()V");
...

            {
                ...
                _jmOpenFile = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "(Ljava/lang/String;)Ljava/io/InputStream;");
...

            {
                ...
                _jmRate = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()V");
...

            {
                ...
                _jmGetRatingCount = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()I");
...

            {
                ...
                _jmGetRatingAverage = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()F");
...

            {
                ...
                _jmGetUserRating = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Ljava/lang/Float;");
...

            {
                ...
                _jmIsFlagged = AndroidJNI.GetMethodID(_jcGameMod, strMethod, "()Z");
        ...
        public GameMod(IntPtr instance)
        {
            _instance = instance;
        }
        ...
        public List<string> getFilenames()
        {
            ...
            Debug.Log(string.Format("{0} Success", MethodBase.GetCurrentMethod().Name));
#endif
            retVal = Plugin.getStringList(result);
            AndroidJNI.DeleteLocalRef(result);
            return retVal;
        }
        ...
        public List<GameModScreenshot> getScreenshots()
        {
#if VERBOSE_LOGGING
            Debug.Log(string.Format("Invoking {0}...", MethodBase.GetCurrentMethod().Name));
#endif
            ...
            List<GameModScreenshot> retVal = new List<GameModScreenshot>();
            ...
            Debug.Log(string.Format("{0} Success", MethodBase.GetCurrentMethod().Name));
#endif
            retVal = Plugin.getGameModScreenshotList(result);
            AndroidJNI.DeleteLocalRef(result);
            return retVal;
        }
        ...
        public Editor edit()
        {
            ...
            IntPtr globalRef = AndroidJNI.NewGlobalRef(retVal);
            AndroidJNI.DeleteLocalRef(retVal);
            return new GameMod.Editor(globalRef);
        }
        ...
        public float? getUserRating()
        {
            ...
            float retVal = Plugin.getFloat(result);
            AndroidJNI.DeleteLocalRef(result);
            return retVal;
        }
