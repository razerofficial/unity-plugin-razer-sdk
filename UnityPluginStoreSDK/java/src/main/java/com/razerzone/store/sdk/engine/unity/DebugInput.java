...
public class DebugInput {
    ...
    public static void debugEngineMotionEvent(MotionEvent motionEvent) {
        Log.i(TAG, "(" + Controller.AXIS_LS_X + ") Controller.AXIS_LS_X value=" + motionEvent.getAxisValue(Controller.AXIS_LS_X) + " source=" + motionEvent.getSource());
        Log.i(TAG, "(" + Controller.AXIS_LS_Y + ") Controller.AXIS_LS_Y value=" + motionEvent.getAxisValue(Controller.AXIS_LS_Y) + " source=" + motionEvent.getSource());
        Log.i(TAG, "(" + Controller.AXIS_RS_X + ") Controller.AXIS_RS_X value=" + motionEvent.getAxisValue(Controller.AXIS_RS_X) + " source=" + motionEvent.getSource());
        Log.i(TAG, "(" + Controller.AXIS_RS_Y + ") Controller.AXIS_RS_Y value=" + motionEvent.getAxisValue(Controller.AXIS_RS_Y) + " source=" + motionEvent.getSource());
        Log.i(TAG, "(" + Controller.AXIS_L2 + ") Controller.AXIS_L2 value=" + motionEvent.getAxisValue(Controller.AXIS_L2) + " source=" + motionEvent.getSource());
        Log.i(TAG, "(" + Controller.AXIS_R2 + ") Controller.AXIS_R2 value=" + motionEvent.getAxisValue(Controller.AXIS_R2) + " source=" + motionEvent.getSource());
    }
