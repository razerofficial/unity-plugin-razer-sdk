...
![image_34](images-md/image_34.png)
...
![image_33](images-md/image_33.png)
...
![image_21](images-md/image_21.png)
...
![image_35](images-md/image_35.png)
...
[Back to Forge general info](https://github.com/ouya/docs/blob/razer-sdk/forge_tv.md#user-content-disable-screensaver)
...
The `Cortex` Plugin includes pre-built Java and Native plugins, recompiling the Java and Native plugin is not required.
...
The [Community Content](https://github.com/ouya/docs/blob/razer-sdk/community_content.md) documentation has a detailed overview of features.
...
![image_17](images-md/image_17.png)
...
![image_27](images-md/image_27.png)
...
![image_18](images-md/image_18.png)
...
![image_26](images-md/image_26.png)
...
![image_25](images-md/image_25.png)
...
![image_24](images-md/image_24.png)
...
![image_29](images-md/image_29.png)
...
If you are on Windows if you install [NVIDIA CodeWorks for Android](https://developer.nvidia.com/codeworks-android), it comes with all of the needed dependencies and is the easiest way to set things up for Android development. Be sure to register for "NVIDIA GameWorks™ Registered Developer Program" to get access to the Tegra Android Developer Pack downloads. [Tegra Registered Developer Program](https://developer.nvidia.com/registered-developer-programs)
